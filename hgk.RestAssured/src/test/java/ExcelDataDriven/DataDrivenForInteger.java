...
public class DataDrivenForInteger {
	// ArrayList to store the specific row values.
	ArrayList<Object> arr = new ArrayList<Object>();

	public ArrayList<Object> excelDataDrivenTest(String headRowName, String rowName) throws IOException {
			...
			if (workbook.getSheetName(i).equalsIgnoreCase("LoginCred")) {
				...
				while (cell.hasNext()) {
					...
					if (cellValue.getStringCellValue().equalsIgnoreCase(headRowName)) {
						column = k;
						System.out.println("" + headRowName + " index is:" + column);
					}
					k++;
				}
